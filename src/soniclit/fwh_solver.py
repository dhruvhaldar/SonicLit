...
def stationary_serial(surf_file : str,  output_filename : str, observer_locations : list, source_times : list, mach_number : list, is_permeable : bool, write : bool = True, ambient_temperature : float = 298, gamma : float = 1.4, MW : float = 28.97):
        ...
        for idx, xo in enumerate(observer_locations):
            ...
            # Optimization: Cascaded array scaling applies the scaling factor directly to the first array
            # calculation and derives subsequent scaled arrays from the previous ones, avoiding unscaled
            # intermediate arrays to reduce peak memory usage and redundant allocations.
