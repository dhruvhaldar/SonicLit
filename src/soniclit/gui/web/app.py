...
with tab_fwh:
    ...
    with col1:
        ...
        st.caption(f"⚠️ **Note:** Application maximum allowed ZIP size is **{MAX_ZIP_SIZE_MB}MB**.")
...
with tab_spectral:
    ...
    with col1:
        ...
        st.caption(f"⚠️ **Note:** Application maximum allowed CSV size is **{MAX_CSV_SIZE_MB}MB**.")
